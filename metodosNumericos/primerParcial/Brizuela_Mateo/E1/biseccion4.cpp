...
int main(int argc, char const *argv[])
{
    ...
    double cViejo = 3.2; // Para medir error entre iteraciones   ACA SE MODIFICA EN LA PRIMERA ITERACION 
    ...
    else
    {
        ...
        do
        {
            ...
            if (criterio == 2)
            {
                ...
                {
                    eRelativo = fabs(c - 1.75) / (0.5 * fabs(c - 1.75)); // aca se hacen las modificaciones para calcular el error
